...
// The header file for this was merged into imgui.h and the funtion names changed to match
//
// IMGUI_API bool        ImGui_ImplSdlGL3_Init(SDL_Window* window);                Became ImGui::Init()
// IMGUI_API void        ImGui_ImplSdlGL3_Shutdown();                              Became ImGui::Shutdown()
// IMGUI_API void        ImGui_ImplSdlGL3_NewFrame(SDL_Window* window);            Became ImGui::Frame()
// IMGUI_API bool        ImGui_ImplSdlGL3_ProcessEvent(SDL_Event* event);          Became ImGui::ProcessEvent()

// Use if you want to reset your rendering device without losing ImGui state.
// IMGUI_API void        ImGui_ImplSdlGL3_InvalidateDeviceObjects();               Became ImGui::InvalidateDeviceObjects()
// IMGUI_API bool        ImGui_ImplSdlGL3_CreateDeviceObjects();                   Became ImGui::CreateDeviceObjects()
...
void ImGui::Frame(SDL_Window* window, HMD* hmd, Controller* controller )
{
    if (!g_FontTexture)
